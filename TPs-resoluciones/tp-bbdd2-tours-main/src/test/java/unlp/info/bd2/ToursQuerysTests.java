...
public class ToursQuerysTests {
    ...
    void getAllPurchasesOfUsernameTest() throws ToursException {
        List<Purchase> purchases1 = this.purchaseService.getAllPurchasesOfUsername("user1");
        ...
        List<Purchase> purchases2 = this.purchaseService.getAllPurchasesOfUsername("user3");
        ...
        List<Purchase> purchases3 = this.purchaseService.getAllPurchasesOfUsername("user5");
        assertEquals(0, purchases3.size());
    }

    @Test
    void getUserSpendingMoreThanTest() throws ToursException {
        List<User> users1 = this.userService.getUserSpendingMoreThan(500);
        ...
        List<User> users2 = this.userService.getUserSpendingMoreThan(800);
        ...
        List<User> users3 = this.userService.getUserSpendingMoreThan(1000);
        assertEquals(0, users3.size());
    }

    @Test
    void getTopNSuppliersInPurchasesTest() throws ToursException {
        List<Supplier> suppliers1 = this.supplierService.getTopNSuppliersInPurchases(3);
        ...
        List<Supplier> suppliers2 = this.supplierService.getTopNSuppliersInPurchases(1);
    ...
    void getCountOfPurchasesBetweenDatesTest() throws ToursException {
        ...
        long countOfPurchasesBetweenDates1 = this.purchaseService.getCountOfPurchasesBetweenDates(Date.valueOf(today.minusDays(25)), Date.valueOf(today.minusDays(15)));
        assertEquals(7, countOfPurchasesBetweenDates1);
        long countOfPurchasesBetweenDates2 = this.purchaseService.getCountOfPurchasesBetweenDates(Date.valueOf(today.minusDays(13)), Date.valueOf(today.minusDays(0)));
        assertEquals(7, countOfPurchasesBetweenDates2);
        long countOfPurchasesBetweenDates3 = this.purchaseService.getCountOfPurchasesBetweenDates(Date.valueOf(today.minusDays(26)), Date.valueOf(today.minusDays(22)));
        assertEquals(0, countOfPurchasesBetweenDates3);
    }

    @Test
    void getRoutesWithStopTest() throws ToursException {
        Stop stop1 = this.stopService.getStopsByNameStart("Diagonal Norte").get(0);
        Stop stop2 = this.stopService.getStopsByNameStart("Teatro Colón").get(0);
        Stop stop3 = this.stopService.getStopsByNameStart("La Boca").get(0);

        List<Route> routes1 = this.routeService.getRoutesWithStop(stop1);
        ...
        List<Route> routes2 = this.routeService.getRoutesWithStop(stop2);
        ...
        List<Route> routes3 = this.routeService.getRoutesWithStop(stop3);
        assertEquals(0, routes3.size());
    }

    @Test
    void getMaxStopOfRoutesTest() throws ToursException {
        Long maxStopOfRoutes = Long.valueOf(this.routeService.getMaxStopOfRoutes());
        assertEquals(9, maxStopOfRoutes);
    }

    @Test
    void getRoutsNotSellTest() throws ToursException {
        List<Route> routsNotSell = this.routeService.getRoutesNotSell();
    ...
    void getTop3RoutesWithMaxRatingTest() throws ToursException {
        List<Route> routesWithMaxRating = this.routeService.getTop3RoutesWithMaxRating();
    ...
    void getMostDemandedServiceTest() throws ToursException {
        Service mostDemandedService = this.serviceService.getMostDemandedService();
    ...
    void getTourGuidesWithRating1Test() throws ToursException {
        List<TourGuideUser> tourGuidesWithRating1 = this.userService.getTourGuidesWithRating1();
